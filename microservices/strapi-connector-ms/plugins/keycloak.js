...
module.exports = fastifyPlugin(async function (fastify, opts, done) {
    const keycloakUrl = opts.KEYCLOAK_AUTH_URL.replace("http://", "").replace("https://", "") + '/realms/' + opts.KEYCLOAK_REALM
